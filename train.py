...
# image_files = [f for f in glob.glob(r'E:\Gender-Detection\gender_dataset_face' + "/**/*", recursive=True) if not os.path.isdir(f)]
...
# save the model to disk
model.save('gender_detection.h5')  # Changed extension to .h5
